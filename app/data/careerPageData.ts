  ...
  banking_and_related_services: {
    ...
    guideSections: [
      ...
      },
      {
        ...
        color: RED,
        content: [
          "After Class 12: Choose Commerce (recommended) or any stream with Math. Enroll in B.Com, BBA, or Economics (Hons). Clear IPMAT or CUET for top colleges.",
          "After Graduation: Appear for Bank PO/Clerk Exams (IBPS, SBI). Enter Public Sector Banks (PSBs). Pursue an MBA (Finance) or CA for Investment Banking or Corporate Banking roles.",
          "Professional Route: Commerce Students have a natural edge in accounting and law. Science Students are highly valued in Fintech and Data Analytics roles. Humanities Students excel in HR and Retail Banking where communication is key."
        ]
      },
      {
        id: "market",
  ...
  chartered_accountant: {
    ...
    guideSections: [
      ...
      },
      {
        ...
        color: RED,
        content: [
          "Chartered Accountancy is a correspondence-based professional course regulated by a single body: The Institute of Chartered Accountants of India (ICAI).",
          "Regional Hubs: ICAI has branches in every major city (Mumbai, Delhi, Chennai, Kolkata, Kanpur).",
          "Coaching Institutions: Private players like VSI Jaipur, J.K. Shah Classes, and online platforms like Physics Wallah/Unacademy offer specialized prep.",
          "Online Learning: Many platforms now offer live classes and recorded lectures for flexible learning."
        ]
      },
      {
        id: "scholarships",
  ...
  cost_accountant: {
      ...
      guideSections: [
        ...
        },
        {
          ...
          color: RED2,
          content: [
            "7:30 AM – Morning Review: Rajesh, a CMA at a leading automotive supplier in Pune, reviews overnight production data and cost variances.",
            "9:00 AM – Cost Analysis Meeting: He presents a detailed breakdown of why manufacturing costs increased by 3% last month—identifying material waste and labor inefficiencies.",
            "11:00 AM – Strategic Planning: The CFO asks Rajesh to model the financial impact of shifting production to a new facility. He builds a comprehensive cost-benefit analysis.",
            "1:00 PM – Lunch with a Client: Rajesh meets a startup founder seeking advice on pricing strategy. He explains how to calculate product costs and set competitive prices.",
            "3:00 PM – Audit Preparation: He supervises his team preparing cost audit documentation for a government inspection—every figure must be defensible.",
            "5:00 PM – Dashboard Updates: Rajesh updates real-time cost dashboards that the management team uses for daily decisions.",
            "6:30 PM – Mentoring: He guides junior CMAs on complex costing methods and industry best practices.",
        ...
        },
        {
          ...
          color: RED5,
          content: [
            "Entry Point: After Class 12 (any stream, but Commerce is preferred).",
            "Stage 1 – Foundation: 4-month course after Class 12. No entrance exam. Very affordable (₹6,000 official fees).",
            "Stage 2 – Intermediate: 8-month course after Foundation. Includes practical training. Fees: ₹23,100.",
            "Stage 3 – Final: 8-month course after Intermediate. Includes 3 months of practical training. Fees: ₹25,000.",
            "Total Duration: 3–5 years (depending on study pace and exam attempts).",
            "Total Official Fees: Around ₹54,000–₹56,000 (one of the most affordable professional qualifications in India).",
            "Practical Training: Mandatory 8 months during Intermediate and 3 months during Final stages.",
            "Stipend During Training: Earn ₹10,000–₹20,000 monthly during practical training.",
            "The 'Gold Combination': Many CMAs pursue CMA + MBA or CMA + LLB for enhanced career prospects.",
          ],
        },
        {
          id: "6",
        ...
        },
        {
          ...
          title: "Where to Study?",
          icon: "🏫",
          description: "Institutions and resources for CMA education",
          color: RED4,
          content: [
            "The Authoritative Body: Institute of Cost Accountants of India (ICAI), established 1944.",
            "ICAI Headquarters: New Delhi.",
            "Regional Offices: Mumbai, Kolkata, Chennai, Bengaluru, Hyderabad.",
            "Chapters: Over 100 chapters across India (including Pune, Ahmedabad, Jaipur, Kochi).",
            "Online Learning: ICAI provides e-learning portals, recorded lectures, and virtual classrooms.",
            "Coaching Institutes: Prominent ones include Disha Academy, Atul Garg Classes, and Asha Tutorials.",
            "Study Groups: Join ICAI-affiliated study circles for peer learning.",
            "Accessibility: Available in Hindi and English; accessible even in rural India through online platforms.",
          ],
        },
        {
          id: "10",
  ...
  economics: {
      ...
      guideSections: [
        ...
        },
        {
          ...
          title: "What Will It Cost?",
          icon: "💰",
          description: "Investment required for an economics education",
          color: RED3,
          content: [
            "Government Colleges: ₹15,000 – ₹1 Lakh (Total 3-year degree).",
            "Private Premier: ₹10 Lakhs – ₹30 Lakhs (Total 3-year degree).",
            "Hostel/Living: ₹12,000 – ₹25,000 per month in metros.",
            "Additional: Laptops and statistical software (though students get free versions).",
            "Master's Degree: ₹5 Lakhs – ₹20 Lakhs depending on institution.",
            "Certifications (CFA/FRM): ₹2 Lakhs – ₹5 Lakhs.",
            "Scholarships: Significantly reduce out-of-pocket costs.",
          ],
        },
        {
          id: "9",
          ...
          content: [
            ...
            "Diversity: St. Xavier's (Mumbai), Loyola College (Chennai), Christ University (Bengaluru).",
            "Online: IGNOU offers distance education in Economics.",
          ],
        },
        {
          id: "10",
  ...
  financial_analyst: {
      ...
      guideSections: [
        ...
        },
        {
          ...
          title: "Where to Study?",
          icon: "🏫",
          description: "Top institutions for financial analyst education in India",
          color: RED4,
          content: [
            "Public: SRCC (Delhi), St. Xavier's (Mumbai), IIMs (Ahmedabad, Bangalore, Calcutta).",
            "Private: NMIMS (Mumbai), Symbiosis (Pune), Christ University (Bengaluru).",
            "Online: NPTEL (Govt), Coursera (Financial Modeling specializations).",
            "CFA Prep: CFA Institute approved prep providers across India.",
            "Distance Learning: IGNOU offers distance education in Commerce.",
            "Specialized: FLAME University (Pune), Ashoka University (Sonipat).",
            "International: Many analysts pursue CFA through online platforms globally.",
          ],
        },
        {
          id: "10",
  ...
  financial_and_investment_planning: {
      ...
      guideSections: [
        ...
        },
        {
          ...
          title: "What Will It Cost?",
          icon: "💰",
          description: "Investment required for a financial planning education",
          color: RED3,
          content: [
            ...
            "SEBI Registration: ₹10,000–₹20,000 for RIA registration.",
            "Scholarships: Can significantly reduce out-of-pocket expenses.",
          ],
        },
        {
          ...
          title: "Where to Study?",
          icon: "🏫",
          description: "Top institutions for financial planning education in India",
          color: RED4,
          content: [
            "Government/Public:",
            ...
            "Specialized: National Institute of Securities Markets (NISM), Patalganga (Established by SEBI).",
            "Online: FPSB India approved online CFP programs.",
          ],
        },
        {
          id: "10",
  ...
  financial_risk_management: {
      ...
      guideSections: [
        ...
        },
        {
          ...
          title: "What Will It Cost?",
          icon: "💰",
          description: "Investment required for a financial risk management education",
          color: RED3,
          content: [
            "B.Com/BBA (Govt): ₹15,000 – ₹60,000 (Total).",
            "MBA (Top B-Schools): ₹15 Lakhs – ₹28 Lakhs.",
            "FRM Certification: Approx. ₹1.2 Lakhs – ₹1.8 Lakhs (Total for both levels, including exam fees and study materials).",
            "Living Costs: ₹15,000 – ₹25,000 per month in major education cities.",
            "Study Materials: ₹50,000–₹1 Lakh for FRM prep courses.",
            "Exam Fees: Included in FRM program costs.",
            "Scholarships: Can significantly reduce out-of-pocket expenses.",
          ],
        },
        {
          ...
          title: "Where to Study?",
          icon: "🏫",
          description: "Top institutions for financial risk management education in India",
          color: RED4,
          content: [
            "Public: SRCC (Delhi), St. Xavier's (Mumbai), IIMs (A, B, C).",
            "Private: NMIMS (Mumbai), Symbiosis (Pune), Christ University (Bengaluru).",
            "Specialized: National Institute of Securities Markets (NISM), Patalganga.",
            "Geographic Diversity: North (IIT Delhi - Financial Tech), South (IIT Madras), East (IIM Calcutta - Quantitative Finance).",
            "Online: GARP approved online FRM programs.",
            "Distance Learning: IGNOU offers distance education in Commerce.",
          ],
        },
        {
  ...
  forensic_scientist: {
    ...
    guideSections: [
      ...
      },
      {
        ...
        title: "Where to Study?",
        icon: "🏫",
        description: "Top institutions for forensic science education in India",
        color: RED4,
        content: [
          "Government (Public):",
          "  • National Forensic Sciences University (NFSU): Gandhinagar, Delhi, Goa, Tripura (The IIT of Forensics)",
          "  • University of Delhi (DU): Department of Anthropology",
  ...
  lawyer: {
    ...
    guideSections: [
      ...
      },
      {
        ...
        title: "Where to Study?",
        icon: "🏫",
        description: "Top institutions for legal education in India",
        color: RED4,
        content: [
          "Government / Public (The 'NLUs' & Traditional Giants):",
          "  • NLSIU, Bangalore: The 'IIT' of Law. Consistently Rank #1",
          "  • NLU, Delhi: Rank #2. Conducts its own exam (AILET)",
          "  • NALSAR, Hyderabad: Rank #3. Exceptional campus and placements",
          "  • WBNUJS, Kolkata: Famous for corporate placements",
          "  • Faculty of Law, Delhi University (DU): The legendary 3-year program",
          "  • Government Law College (GLC), Mumbai: Oldest in Asia, excellent for litigation",
          "Private:",
  ...
  industrial_designer: {
    ...
    guideSections: [
      ...
      },
      {
        ...
        title: "Where to Study?",
        icon: "🏫",
        description: "Top institutions for industrial design education in India",
        color: RED4,
        content: [
          "Government (Public) - The Gold Standard:",
          "  • National Institute of Design (NID): Ahmedabad (Main Campus), AP, Haryana, MP, Assam",
          "  • IDC School of Design, IIT Bombay: Excellent for blending tech with design",
          "  • IIITDM Jabalpur: Specializes in Design and Manufacturing",
          "  • DoD (Department of Design), IIT Guwahati/IIT Delhi",
          "Private - World Class Facilities:",
          "  • MIT Institute of Design (MIT-ID), Pune: Known for Product Design",
          "  • Srishti Manipal Institute, Bangalore: Artistic and experimental",
          "  • UPES School of Design, Dehradun: Good industry connect",
          "  • ISDI (Atlas SkillTech), Mumbai: Urban campus with corporate ties",
        ],
      },
      {
        id: "10",
  ...
  industrial_engineer: {
    ...
    guideSections: [
      ...
      },
      {
        ...
        title: "Where to Study?",
        icon: "🏫",
        description: "Top institutions for industrial engineering education in India",
        color: RED4,
        content: [
          "Government (Public):",
          "  • IIT Kharagpur: The pioneer. Offers 'Industrial & Systems Engineering'",
          "  • IIT Delhi: Offers 'Production and Industrial Engineering'",
          "  • NIT Trichy & NIT Warangal: Top NITs for this branch",
          "  • College of Engineering Pune (COEP): Very prestigious state college",
          "Private:",
          "  • BITS Pilani: Offers 'M.Sc. (Tech) Engineering Technology' or Mechanical with IE focus",
          "  • Manipal Institute of Technology (MIT): Offers 'Industrial & Production Engineering'",
          "  • VIT Vellore, PSG College of Technology, Coimbatore",
        ],
      },
      {
        id: "10",
  ...
  mechanical_engineer: {
    ...
    guideSections: [
      ...
      },
      {
        ...
        title: "Where to Study?",
        icon: "🏫",
        description: "Top institutions for mechanical engineering education in India",
        color: RED4,
        content: [
          "Government (Public):",
          "  • IIT Madras & IIT Bombay: Consistently ranked #1 & #2 for Mechanical Engineering",
          "  • IIT Roorkee: Famous for its engineering heritage",
          "  • NIT Trichy & NIT Warangal: The best among NITs",
          "  • College of Engineering Pune (COEP): Legendary state college",
          "  • Jadavpur University, Kolkata: Extremely low fees, high ROI",
          "Private:",
          "  • BITS Pilani: Industry-focused curriculum",
          "  • Manipal Institute of Technology (MIT): Great student projects",
